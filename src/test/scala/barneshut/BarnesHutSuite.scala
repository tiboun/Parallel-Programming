...
import FloatOps._
  ...
  test("Leaf.insert(b) should return a Fork with size > minimumSize") {
    val b1 = new Body(3f, 54f, 46f, 0f, 0f)
    val b2 = new Body(123f, 18f, 26f, 0f, 0f)
    val b3 = new Body(123f, 18f, 26f, 0f, 0f)
    val leaf = Leaf(17.5f, 27.5f, 5f, Seq(b1,b2))
    val insert: Quad = leaf.insert(b3)
    println(insert)
  }
